...
package com.xuie.gmeizhi.service;
...
import com.xuie.gmeizhi.ui.main.MainActivity;
import com.xuie.gmeizhi.util.HeadsUps;
...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    @Override public void onReceive(Context context, Intent intent) {
        if (PreferenceUtils.getBoolean(context, context.getString(R.string.action_notifiable), true)) {
